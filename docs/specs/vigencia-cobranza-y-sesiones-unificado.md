...
>
> **El cron SIGUE PAUSADO.** El fix hacia adelante ya protege pagos nuevos, y 61 de las filas ya visibles están corregidas. Reactivar ahora dejaría expuestas las 63 ambiguas (su `expires_at` sigue desactualizado) — decisión pendiente con el usuario: revisar caso por caso (Dynasty y MMA Blair Team concentran el 92%), o aceptar el riesgo residual y reactivar igual.
