-- Migration to fix school_athletes view to include inactive adult athletes
-- This allows the management panel to list inactive adult athletes and toggle their status correctly.
