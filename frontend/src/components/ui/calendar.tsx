  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        caption_label: props.captionLayout === "dropdown" || props.captionLayout === "dropdown-buttons" ? "sr-only" : "text-sm font-medium",
        ...
        vhidden: "sr-only",
        dropdown: "inline-flex items-center space-x-1 bg-secondary/50 text-foreground text-xs font-semibold px-2 py-1 rounded-md border border-border/50 hover:bg-accent transition-colors cursor-pointer appearance-none",
