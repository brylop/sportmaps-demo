...
import trialClassesSelfRouter from './routes/trial-classes-self.routes';
...
app.use('/api/v1/help', generalLimiter, helpRoutes);
...
app.use('/api/v1/trial-classes-self', generalLimiter, trialClassesSelfRouter);
